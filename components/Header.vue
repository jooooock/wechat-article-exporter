<template>
  <header class="sticky top-0 z-20 flex-none px-5 py-2 border-b flex items-center justify-between antialiased">
    ...
    <div class="hidden space-x-5 lg:flex lg:items-center">
      ...
      <a href="https://github.com/jooooock/wechat-article-exporter" class="ml-6 block text-slate-400 hover:text-slate-500 dark:hover:text-slate-300" title="goto github">
...
const emit = defineEmits(['select:account', 'search:article'])
